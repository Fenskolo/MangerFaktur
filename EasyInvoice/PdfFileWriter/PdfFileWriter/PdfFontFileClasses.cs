...
namespace PdfFileWriter
{
    ...
    internal class FontFileHeader
    {
        ...
        internal ushort RangeShift => (ushort) (16 * NumTables - SearchRange);
    }
    ...
    internal class cmapSubTbl : IComparable<cmapSubTbl>
    {
        ...
        internal ushort[]
            GlyphArray; // glyph array translate character for format 0 or index for format 4 to glyph code
        ...
        // 2 x segCount
        internal ushort SegCountX2 => (ushort) (2 * SegCount);
        ...
        // NumTables x 16-searchRange.
        internal ushort RangeShift => (ushort) (2 * SegCount - SearchRange);
    ...
    {
        internal uint
            ChecksumAdjustment; // font file overall checksum. To compute: set it to 0, sum the entire font, then store 0xB1B0AFBA - sum.
    ...
    internal class maxpTable
    {
        ...
        internal ushort
            maxComponentElements; // Maximum number of components referenced at “top level” for any composite glyph.
    ...
    internal enum CompFlag
    {
        ...
        ScaledComponentOffset =
            0x800, // bit11 Composite designed to have the component offset scaled (designed for Apple rasterizer).

        UnscaledComponentOffset =
            0x1000 // bit12 Composite designed not to have the component offset scaled (designed for the Microsoft TrueType rasterizer).
    }
}