...
namespace PdfFileWriter
{
    ...
    public class PdfInfo : PdfObject
    {
        ...
        ///     <list type="table">
        ///         <item>
        ///             <description>Creation date set to current local system date</description>
        ///         </item>
        ///         <item>
        ///             <description>Modification date set to current local system date</description>
        ///         </item>
        ///         <item>
        ///             <description>Creator is PdfFileWriter C# Class Library Version No</description>
        ///         </item>
        ///         <item>
        ///             <description>Producer is PdfFileWriter C# Class Library Version No</description>
        ///         </item>
        ///     </list>
        /// </remarks>
