...
namespace PdfFileWriter
{
    ...
    ///         <a
    ///             href="http://www.codeproject.com/Articles/570682/PDF-File-Writer-Csharp-Class-Library-Version#DataTableSupport">
    ///             2.12
    ///             Data Table Support
    ///         </a>
    ///     </para>
    ...
    public class PdfTableCell
    {
        ...
        {
            set => AnnotAction = new AnnotWebLink(value);
        }
        ...
        /// <remarks>
        ///     <para>
        ///         The user can activate the annotation action by clicking anywhere in the cell area.
        ///         Right click for attached file.
        ///     </para>
        ///     <list type="table">
        ///         <item>
        ///             <description>Weblink action to activate web browser.</description>
        ///         </item>
        ///         <item>
        ///             <description>Go to action to jump to another page in the document.</description>
        ///         </item>
        ///         <item>
        ///             <description>Display media action to isplay video or play sound.</description>
        ///         </item>
        ///         <item>
        ///             <description>File attachment to save or view embedded file.</description>
        ///         </item>
        ///     </list>
        /// </remarks>
        ...
        internal void DrawCellInitialization()
        {
            ...
            if (Value != null)
            {
                ...
                if (ValueType == typeof(string))
                {
                    ...
                    if (Style.MultiLineText)
                    {
                        ...
                        TextBox = new TextBox(ClientRight - ClientLeft, Style.TextBoxFirstLineIndent,
                            Style.TextBoxLineBreakFactor);
            ...
            {
                CellHeight += TextBox.BoxHeightExtra(ref TextBoxLineNo, out var LineEnd,
        ...
        internal void TextBoxInitialization()
        {
            ...
            var TextBoxHeightPageBreak = TextBoxHeight;
        ...
        internal void DrawCell()
        {
            ...
            switch (Type)
            {
                ...
                case CellType.TextBox:
                    ...
                    // draw textbox
                    Parent.Contents.SaveGraphicsState();
                    LineEnd = Parent.Contents.DrawText(LeftPos(TextBox.BoxWidth), ref YPos,
                        ClientBottom - Parent.Epsilon, TextBoxLineNo,
                        Style.TextBoxLineExtraSpace, Style.TextBoxParagraphExtraSpace, Style.TextBoxTextJustify,
                        TextBox);
                    Parent.Contents.RestoreGraphicsState();
                ...
                // image
                case CellType.Image:
                    Parent.Contents.DrawImage(Image, LeftPos(ImageWidth), TopPos(ImageHeight) - ImageHeight, ImageWidth,
                        ImageHeight);
                    break;

                // qrcode
                case CellType.QRCode:
                    Parent.Contents.DrawQRCode(QRCode, LeftPos(QRCodeWidth), TopPos(QRCodeWidth) - QRCodeWidth,
                        QRCodeWidth);
                    break;
                ...
                case CellType.Barcode:
                    Parent.Contents.DrawBarcode(LeftPos(BarcodeBox.TotalWidth) + BarcodeBox.OriginX,
                        ...
                        TextJustify.Left, Style.BarcodeBarWidth, Style.BarcodeHeight, Style.ForegroundColor, Barcode,
        ...
        {
            if ((Style.Alignment &
                 (ContentAlignment.TopLeft | ContentAlignment.MiddleLeft | ContentAlignment.BottomLeft)) != 0)
            {
            ...
            if ((Style.Alignment &
                 (ContentAlignment.TopRight | ContentAlignment.MiddleRight | ContentAlignment.BottomRight)) != 0)
            {
            ...
            if ((Style.Alignment & (ContentAlignment.TopCenter | ContentAlignment.MiddleCenter |
                                    ContentAlignment.BottomCenter)) != 0)
            {
