...
namespace PdfFileWriter
{
    ...
    public class PdfAxialShading : PdfObject
    {
        ...
        {
            SetAxisDirection(MediaBrush.StartPoint.X, MediaBrush.StartPoint.Y, MediaBrush.EndPoint.X,
                MediaBrush.EndPoint.Y,
        ...
        internal override void WriteObjectToPdfFile()
        {
            ...
            {
                var RelStartPointX = BBoxLeft * (1.0 - StartPointX) + BBoxRight * StartPointX;
                var RelStartPointY = BBoxBottom * (1.0 - StartPointY) + BBoxTop * StartPointY;
                var RelEndPointX = BBoxLeft * (1.0 - EndPointX) + BBoxRight * EndPointX;
                var RelEndPointY = BBoxBottom * (1.0 - EndPointY) + BBoxTop * EndPointY;
