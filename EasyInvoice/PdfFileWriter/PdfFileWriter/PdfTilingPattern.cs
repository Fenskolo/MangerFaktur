...
namespace PdfFileWriter
{
    ...
    /// <remarks>
    ///     <para>
    ///         <a href="http://www.codeproject.com/Articles/570682/PDF-File-Writer-Csharp-Class-Library-Version#TilingPattern">
    ///             For
    ///             example of using tiling pattern see 3.3. Tiling Pattern
    ///         </a>
    ///     </para>
    ///     <para>
    ///         <a
    ///             href="http://www.codeproject.com/Articles/570682/PDF-File-Writer-Csharp-Class-Library-Version#TilingPattern2">
    ///             or
    ...
    public class PdfTilingPattern : PdfContents
    {
        ...
        {
            // add items to dictionary
            Dictionary.AddFormat("/Matrix", "[{0} 0 0 {1} {2} {3}]", Round(ScaleX), Round(ScaleY), ToPt(OriginX),
                ToPt(OriginY));
        }
        ...
        )
        {
            ...
            Dictionary.AddFormat("/Matrix", "[{0} {1} {2} {3} {4} {5}]", Round(a), Round(b), Round(c), Round(d),
                ToPt(e), ToPt(f));
        }
