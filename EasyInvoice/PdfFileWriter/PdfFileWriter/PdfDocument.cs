...
namespace PdfFileWriter
{
    ...
    ///     <para>
    ///         <a
    ///             href="http://www.codeproject.com/Articles/570682/PDF-File-Writer-Csharp-Class-Library-Version#DocumentCreation">
    ///             For
    ///             example of document creation see 3.1. Document Creation Overview
    ///         </a>
    ///     </para>
    /// </remarks>
    /////////////////////////////////////////////////////////////////////
    public class PdfDocument : IDisposable
    {
        ...
        internal static double[] UnitInPoints =
        {
            1.0, // Point
            72.0, // Inch
            72.0 / 2.54, // cm
        ...
        internal static SizeD[] PaperTypeSize =
        {
        ...
        ///     If debug flag is true, the library will not compress contents, will replace images and font file with text place
        ///     holder.
        ...
        internal List<PdfObject>
            ObjectArray = new List<PdfObject>(); // list of all PDF indirect objects for this document
        ...
        ///     <para>Scale factor is 1.0.</para>
        ///     <para>
        ///         The PDF document will be saved in the stream argument. The stream can
        ...
        ///         as per width and height arguments in user units.
        ///     </para>
        ///     <para>
        ///         Page orientation is portrait if width is less than height.
        ///         Otherwise it is landscape.
        ///     </para>
        ///     <para>
        ///         Scale factor is user unit of measure expressed in points.
        ///         For example, Inch has scale factor of 72.0.
        ///     </para>
        ///     <para>The PDF document will be saved in a file named FileName.</para>
        /// </remarks>
        ////////////////////////////////////////////////////////////////////
        ...
        {
            // constructor helper
            var Scale = UnitInPoints[(int) UnitOfMeasure];
        ...
        )
        {
            ...
            var Scale = UnitInPoints[(int) UnitOfMeasure];
            var Width = PaperTypeSize[(int) PaperType].Width;
            var Height = PaperTypeSize[(int) PaperType].Height;
        ...
        ///     Current page count
        /// </remarks>
        public int PageCount => PageArray.Count;
        ...
        internal void AddDestToLinkAnnot()
        {
            ...
            foreach (var Annot in LinkAnnotArray)
            {
                ...
                var LocMarkerName = ((AnnotLinkAction) Annot.AnnotAction).LocMarkerName;
                ...
                Annot.Dictionary.AddFormat("/A", "<</Type/Action/S/GoTo/D{0}>>",
                    Annot.Document.LocMarkerArray[Index].DestStr);
            }
        }
        ...
        )
        {
            ...
            var ByteArray = TextToByteArray(Text);
