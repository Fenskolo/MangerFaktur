...
namespace PdfFileWriter
{
    ...
    {
        private readonly PdfDictionary MediaClip;
        private readonly PdfDictionary MediaPlay;
        private readonly PdfDictionary MediaPlayBE;
        private readonly PdfDictionary MediaScreenParam;
        private readonly PdfDictionary MediaScreenParamBE;

        private readonly PdfDictionary Rendition;
        private readonly PdfDictionary TempFilePermissions;
        ...
        /// </summary>
        public PdfEmbeddedFile MediaFile { get; }
        ...
        )
        {
            ...
            // Table 9.19 page 774
            var FloatingWindow = new PdfDictionary(this);
