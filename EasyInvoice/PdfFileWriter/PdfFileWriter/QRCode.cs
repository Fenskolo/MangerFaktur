...
namespace PdfFileWriter
{
    internal class QRCode
    {
        ...
        protected const int BLOCKS_GROUP1 = 0;

        // B-Number of data codewords in blocks of group 1
        protected const int DATA_CODEWORDS_GROUP1 = 1;

        // C-Number of blocks in group 2
        protected const int BLOCKS_GROUP2 = 2;

        // D-Number of data codewords in blocks of group 2
        protected const int DATA_CODEWORDS_GROUP2 = 3;
        ...
        protected static readonly short[] MaxCodewordsArray =
        {
            0,
        ...
        protected static readonly short[] FormatInfoArray =
        {
        ...
        protected static readonly int[] VersionInformation =
        {
        ...
        {
            {
                FixedBlack, FixedBlack, FixedBlack, FixedBlack, FixedBlack, FixedBlack, FixedBlack, FixedWhite,
                FormatWhite
            },
            {
                FixedBlack, FixedWhite, FixedWhite, FixedWhite, FixedWhite, FixedWhite, FixedBlack, FixedWhite,
                FormatWhite
            },
            {
                FixedBlack, FixedWhite, FixedBlack, FixedBlack, FixedBlack, FixedWhite, FixedBlack, FixedWhite,
                FormatWhite
            },
            {
                FixedBlack, FixedWhite, FixedBlack, FixedBlack, FixedBlack, FixedWhite, FixedBlack, FixedWhite,
        ...
        protected uint BitBuffer;
        protected int BitBufferLen;
        protected int BlocksGroup1;
        protected int BlocksGroup2;
        protected byte[] CodewordsArray;
        protected int CodewordsPtr;
        protected int DataCodewordsGroup1;
        protected int DataCodewordsGroup2;

        protected int EncodedDataBits;
        protected int ErrCorrCodewords;
        protected ErrorCorrection ErrorCorrection;
        protected int MaskCode;
        protected byte[,] MaskMatrix;
        protected int MaxCodewords;
        protected int MaxDataBits;

        protected int MaxDataCodewords;
        ...
        /// </summary>
        public int MatrixDimension { get; protected set; } // Code matrix side in bits
        ...
        {
            // index shortcut
            var BlockInfoIndex = (Version - 1) * 4 + (int) ErrorCorrection;
        ...
        protected void BuildBaseMatrix()
        {
            ...
            if (Version > 1)
            {
                var AlignPos = AlignmentPositionArray[Version];
        ...
        internal static void PolynominalDivision(byte[] Polynomial, int PolyLength, byte[] Generator,
