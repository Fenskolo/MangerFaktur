...
namespace PdfFileWriter
{
    ...
    {
        private static readonly string[] ResCodeStr =
            {"/Font <<", "/Pattern <<", "/Shading <<", "/XObject <<", "/ExtGState <<"};
        ...
        )
        {
            ...
            // add all resources
            var ResCodeType = ' ';
            foreach (var Resource in ResObjects)
            {
        ...
        )
        {
            ...
            var ReadAdler32 = Adler32Checksum(InputBuf);
