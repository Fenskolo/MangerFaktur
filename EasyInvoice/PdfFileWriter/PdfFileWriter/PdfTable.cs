...
namespace PdfFileWriter
{
    ...
    ///     </para>
    ///     <para>
    ///         <a href="http://www.codeproject.com/Articles/570682/PDF-File-Writer-Csharp-Class-Library-Version#DrawDataTable">
    ///             For
    ///             example of drawing image see 3.13. Draw Book Order Form
    ///         </a>
    ///     </para>
    /// </remarks>
    public class PdfTable
    {
        ...
        /// </remarks>
        public PdfTableCell[] Cell => _Cell;

        /// <summary>
        ///     Creates a cell style object as a copy of the default cell style.
        /// </summary>
        public PdfTableStyle CellStyle => new PdfTableStyle(DefaultCellStyle);
        ...
        ///     </para>
        /// </remarks>
        public double[] ColumnPosition => (double[]) _ColumnPosition.Clone();
        ...
        ///     </para>
        /// </remarks>
        public double[] ColumnWidth => (double[]) _ColumnWidth.Clone();
        ...
        /// </remarks>
        public PdfTableCell[] Header => _Header;
        ...
        /// </summary>
        public PdfTableStyle HeaderStyle => new PdfTableStyle(DefaultHeaderStyle);
        ...
        ///     </para>
        /// </remarks>
        public double[] RowPosition => BorderYPos.ToArray();
        ...
        )
        {
            ...
            // test for new page
            if (NewPage || _RowTopPosition - (TextBoxRowHeight +
                                              (HeaderHeight != 0.0
                                                  ? HeaderHeight + 2.0 * Borders.HeaderHorBorder.HalfWidth
