...
namespace PdfFileWriter
{
    ...
    /// <remarks>
    ///     <para>
    ///         <a href="http://www.codeproject.com/Articles/570682/PDF-File-Writer-Csharp-Class-Library-Version#DrawTextBox">
    ///             For
    ///             example of drawing TextBox see 3.12. Draw Text Box
    ///         </a>
    ///     </para>
    /// </remarks>
    public class TextBox
    {
        private readonly List<TextBoxLine> LineArray;

        private readonly double LineBreakFactor; // should be >= 0.1 and <= 0.9
        private readonly List<TextBoxSeg> SegArray;
        ...
        ///     Gets line count.
        /// </summary>
        public int LineCount => LineArray.Count;
        ...
        public TextBoxLine this[int Index] => LineArray[Index];
        ...
        )
        {
            ...
            if (SegArray.Count == 0 ||
                !SegArray[SegArray.Count - 1].IsEqual(Font, FontSize, DrawStyle, FontColor, AnnotAction))
            {
            ...
            // loop for characters
            for (var TextPtr = 0; TextPtr < Text.Length; TextPtr++)
            {
                // shortcut to current character
                var CurChar = Text[TextPtr];
                ...
                // character width
                var CharWidth = Font.CharWidth(FontSize, Seg.DrawStyle, CurChar);
        ...
        private void BreakLine()
        {
            ...
            var BreakSeg = SegArray[BreakSegIndex];

            // add extra segment to segment array
            if (BreakPtr != 0)
            {
                var ExtraSeg = new TextBoxSeg(BreakSeg)
                {
                    SegWidth = BreakWidth,
                    Text = BreakSeg.Text.Substring(0, BreakPtr)
                };
        ...
        )
        {
            ...
            if (BreakSegIndex > 0)
            {
                ...
                var LineSegArray = new TextBoxSeg[BreakSegIndex];
