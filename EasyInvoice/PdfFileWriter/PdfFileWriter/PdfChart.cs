...
namespace PdfFileWriter
{
    ...
    ///         <a
    ///             href="http://www.codeproject.com/Articles/570682/PDF-File-Writer-Csharp-Class-Library-Version#ChartingSupport">
    ///             2.10
    ///             Charting Support
    ///         </a>
    ///     </para>
    ///     <para>
    ///         <a href="http://www.codeproject.com/Articles/570682/PDF-File-Writer-Csharp-Class-Library-Version#DrawChart">
    ///             For
    ///             example of drawing image see 3.11. Draw Pie Chart
    ///         </a>
    ///     </para>
    /// </remarks>
    public class PdfChart : PdfImage
    {
        ...
        /// </summary>
        public double Width { get; } // width in user units

        /// <summary>
        ///     Chart height in user units.
        /// </summary>
        public double Height { get; } // height in user units
