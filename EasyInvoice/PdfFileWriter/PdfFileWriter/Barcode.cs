...
namespace PdfFileWriter
{
    ...
    ///         <a
    ///             href="http://www.codeproject.com/Articles/570682/PDF-File-Writer-Csharp-Class-Library-Version#BarcodeSupport">
    ///             2.5
    ///             Barcode Support
    ///         </a>
    ///     </para>
    ...
    public class Barcode
    {
        ...
        /// </summary>
        public int[] CodeArray => (int[]) _CodeArray.Clone();
        ...
        )
        {
            ...
            var TextWidth = TextFont.TextWidth(FontSize, Text);
            double OriginX = 0;
            ...
            // calculate height
            var TextHeight = TextFont.LineSpacing(FontSize);
    ...
    public class Barcode128 : Barcode
    {
        ...
        )
        {
            ...
            var TrailDigitsCount = TrailFnc1Start - TrailDigitsStart;
            ...
            {
                // create code array
                _CodeArray = new int[1 + LeadFnc1End + (LeadDigitsEnd - LeadFnc1End) / 2 + (TextLen - TrailFnc1Start) +
                                     2];
            ...
            else
            {
                ...
                var StartOfNonDigits = LeadDigitsEnd;
                var StartOfDigits = LeadDigitsEnd;
                int EndOfDigits;
                ...
                Array.Resize(ref _CodeArray, CodeEnd + 2);
            }
        ...
        )
        {
            ...
            if (_CodeArray[Length - 1] != STOP)
            {
                ...
                Length += 2;
                Array.Resize(ref _CodeArray, Length);
            }
            ...
            switch (_CodeArray[0])
            {
                ...
                default:
                    ...
                    throw new ApplicationException(
                        "Barcode128: Code array first element must be start code (103, 104, 105)");
            }
        ...
        )
        {
            ...
            var CurCodeSet = CodeSet.Undefined;

            for (var Index = TextStart; Index < TextEnd; Index++)
            {
                // get char
                ...
                // invalid character
                throw new ApplicationException(
                    "FormaCode128 input characters must be 0 to 127 or function code (256, 257, 258)");
            }
        }
    ...
    public class Barcode39 : Barcode
    {
        ...
        ///     <list type="table">
        ///         <item>
        ///             <description>Digits 0 to 9</description>
        ///         </item>
        ///         <item>
        ///             <description>Capital Letters A to Z</description>
        ///         </item>
        ///         <item>
        ...
        ///         <item>
        ///             <description>
        ///                 Asterisk '*' (This is the start and stop
        ...
        ///     <list type="table">
        ///         <item>
        ///             <term>0 to 9</term><description>Digits 0 to 9</description>
        ///         </item>
        ///         <item>
        ///             <term>10 to 35</term><description>Capital Letters A to Z</description>
        ///         </item>
        ///         <item>
        ///             <term>36</term><description>Dash '-'</description>
        ///         </item>
        ///         <item>
        ///             <term>37</term><description>Period '.'</description>
        ///         </item>
        ///         <item>
        ///             <term>38</term><description>Space ' '</description>
        ///         </item>
        ///         <item>
        ///             <term>39</term><description>Dollar '$'</description>
        ///         </item>
        ///         <item>
        ///             <term>40</term><description>Slash '/'</description>
        ///         </item>
        ///         <item>
        ///             <term>41</term><description>Plus '+'</description>
        ///         </item>
        ///         <item>
        ///             <term>42</term><description>Percent '%'</description>
        ///         </item>
        ///         <item>
        ///             <term>43</term>
        ///             <description>
        ...
        )
        {
            ...
            {
                var TempArray = new int[_CodeArray.Length + 1];
            ...
            {
                Array.Resize(ref _CodeArray, _CodeArray.Length + 1);
            ...
            var Str = new StringBuilder();
            for (var Index = 1; Index < _CodeArray.Length - 2; Index++)
            {
                var Code = _CodeArray[Index];
    ...
    public class BarcodeEAN13 : Barcode
    {
        ...
        )
        {
            ...
            // encode the text
            var CodePtr = 0;
            for (var Index = Length == 12 ? 0 : 1; Index < Length; Index++)
            {
            ...
            // add it to text
            Text = Text.Substring(0, Text.Length - 1) + (char) ('0' + _CodeArray[BARCODE_LEN - 1]);
        ...
        )
        {
            ...
            // convert code array to text
            for (var Index = 0; Index < BARCODE_LEN - 1; Index++)
            {
                var Code = _CodeArray[Index];
        ...
        )
        {
            ...
            {
                var Index = BarIndex - (LEAD_BARS + BARCODE_HALF_LEN * CODE_CHAR_BARS + SEPARATOR_BARS);
