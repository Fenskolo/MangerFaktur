...
namespace PdfFileWriter
{
    ...
    public class PointD
    {
        ...
        )
        {
            ...
            var L1DXY = L1.P2.X * L1.P1.Y - L1.P2.Y * L1.P1.X;
            var L2DXY = L2.P2.X * L2.P1.Y - L2.P2.Y * L2.P1.X;
    ...
    public class LineD
    {
        ...
        ///     Delta X
        /// </summary>
        public double DX => P2.X - P1.X;

        /// <summary>
        ///     Delta Y
        /// </summary>
        public double DY => P2.Y - P1.Y;
    ...
    public class BezierD
    {
        ...
        )
        {
            ...
            var Alpha = Math.Atan2(Line.DY, Line.DX);
        ...
        {
            return new BezierD(X + Radius, Y, X + Radius, Y + CircleFactor * Radius, X + CircleFactor * Radius,
                Y + Radius, X, Y + Radius);
        }
        ...
        {
            return new BezierD(X, Y + Radius, X - CircleFactor * Radius, Y + Radius, X - Radius,
                Y + CircleFactor * Radius, X - Radius, Y);
        }
        ...
        {
            return new BezierD(X + Width, Y, X + Width, Y + CircleFactor * Height, X + CircleFactor * Width, Y + Height,
                X, Y + Height);
        }
        ...
        {
            return new BezierD(X, Y + Height, X - CircleFactor * Width, Y + Height, X - Width,
                Y + CircleFactor * Height, X - Width, Y);
        }
