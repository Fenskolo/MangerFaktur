...
namespace PdfFileWriter
{
    ...
    public static class ImageSizePos
    {
        ...
        {
            return ImageArea(ImageWidthPix, ImageHeightPix, DrawArea.Left, DrawArea.Bottom, DrawArea.Width,
                DrawArea.Height, Alignment);
        }
        ...
        )
        {
            ...
            // position rectangle
            return new PdfRectangle(DrawAreaLeft + DeltaX, DrawAreaBottom + DeltaY, DrawAreaLeft + DeltaX + Width,
                DrawAreaBottom + DeltaY + Height);
        }
